...
const Header = () => {
  ...
  return (
    <header className="max-w-full mx-auto bg-white/20 backdrop-blur-md grid items-center grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 p-5 md:p-10 py-3 md:py-6 fixed top-0 inset-x-0 z-50">
      <Link className="w-max ps-8 md:col-span-1 " to="/">
      ...
      <div className="flex items-center w-full gap-1.5 row-start-2 col-span-2 md:row-start-1 md:col-span-2 md:col-start-2">
        ...
        >
          <div
            className={`border-neutral-300 w-10 h-10 col-start-1 row-start-1 bg-white border rounded-full shadow transition-transform transform ${isSearchIcon ? "translate-x-0" : "translate-x-full"}`}
          ></div>
          <div
      ...
      <nav className="ml-auto md:col-span-1 lg:pe-10">
        <ul className="hidden lg:flex items-center gap-3 justify-end">
          ...
          <li>
            <CustomButton
              BtnText="List"
              className="bg-neutral-100 hover:bg-neutral-100/80 text-black"
            />
          </li>
          <li>
            <CustomButton
          ...
          <li className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium bg-neutral-100 hover:bg-neutral-100/80  dark:text-neutral-50 h-10 p-2.5 rounded-full">
            <Link>
              <svg
                ...
                class="lucide lucide-settings w-5 h-5"
              >
          ...
          <li className="relative inline-flex items-center justify-center  text-sm font-medium dark:text-neutral-50h-10 p-2.5 rounded-full bg-neutral-100">
            <Link to="/cartpage">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
      ...
      {menuOpen && (
        ...
        >
          ...
          <div
            ...
            role="none"
            class="shrink-0 bg-neutral-200 dark:bg-neutral-800 h-[1px] w-full my-4"
          ></div>
          <nav
            aria-label="Main"
            data-orientation="horizontal"
